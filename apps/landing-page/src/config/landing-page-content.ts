    ...
    beforeAfter: {
      ...
      after: {
        ...
        badges: [
          ...
          t('landing.beforeAfter.after.badges.5'),
        ],
      },
    },
    features: {
    ...
    storeLayer: {
      domaines: {
        ...
        badges: [
          ...
          t('landing.storeLayer.domaines.badges.4'),
          t('landing.storeLayer.domaines.badges.5'),
          t('landing.storeLayer.domaines.badges.6'),
          t('landing.storeLayer.domaines.badges.7'),
          t('landing.storeLayer.domaines.badges.8'),
          t('landing.storeLayer.domaines.badges.9'),
          t('landing.storeLayer.domaines.badges.10'),
          t('landing.storeLayer.domaines.badges.11'),
          t('landing.storeLayer.domaines.badges.12'),
          t('landing.storeLayer.domaines.badges.13'),
          t('landing.storeLayer.domaines.badges.14'),
          t('landing.storeLayer.domaines.badges.15'),
          t('landing.storeLayer.domaines.badges.16'),
        ],
      },
      zones: {
        ...
        badges: [
          ...
          t('landing.storeLayer.zones.badges.4'),
          t('landing.storeLayer.zones.badges.5'),
          t('landing.storeLayer.zones.badges.6'),
          t('landing.storeLayer.zones.badges.7'),
          t('landing.storeLayer.zones.badges.8'),
          t('landing.storeLayer.zones.badges.9'),
          t('landing.storeLayer.zones.badges.10'),
        ],
      },
      equipements: {
        ...
        badges: [
          ...
          t('landing.storeLayer.equipements.badges.4'),
          t('landing.storeLayer.equipements.badges.5'),
          t('landing.storeLayer.equipements.badges.6'),
          t('landing.storeLayer.equipements.badges.7'),
          t('landing.storeLayer.equipements.badges.8'),
          t('landing.storeLayer.equipements.badges.9'),
          t('landing.storeLayer.equipements.badges.10'),
          t('landing.storeLayer.equipements.badges.11'),
          t('landing.storeLayer.equipements.badges.12'),
          t('landing.storeLayer.equipements.badges.13'),
          t('landing.storeLayer.equipements.badges.14'),
        ],
      },
    },
    incidentPath: {
