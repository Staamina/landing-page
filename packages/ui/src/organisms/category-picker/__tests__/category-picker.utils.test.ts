...
describe('category-picker.utils', () => {
  ...
  describe('getAllDescendantIds', () => {
    it('should return all descendant IDs including the node itself', () => {
      ...
      expect(descendantIds).toContain('cat-1');
      expect(descendantIds).toContain('cat-2');
      expect(descendantIds).toContain('cat-3');
    ...
    it('should handle deeply nested hierarchies', () => {
      ...
      expect(descendantIds).toContain('cat-4');
      expect(descendantIds).toContain('cat-5');
      expect(descendantIds).toContain('cat-6');
      expect(descendantIds).toHaveLength(3);
    });
  });
  ...
  describe('getAllAncestorIds', () => {
    it('should return all ancestor IDs', () => {
      ...
      expect(ancestorIds).toContain('cat-5');
      expect(ancestorIds).toContain('cat-4');
      expect(ancestorIds).toHaveLength(2);
      expect(ancestorIds[0]).toBe('cat-5');
  ...
  describe('getCategoryBreadcrumb', () => {
    ...
    it('should return full breadcrumb path for nested categories', () => {
      ...
      expect(breadcrumb[0].id).toBe('cat-4');
      expect(breadcrumb[1].id).toBe('cat-5');
      expect(breadcrumb[2].id).toBe('cat-6');
    });
  ...
  describe('filterCategoriesBySearch', () => {
    ...
    it('should find nested categories by name', () => {
      ...
      expect(matches[0].breadcrumb[0].id).toBe('cat-4');
      expect(matches[0].breadcrumb[1].id).toBe('cat-5');
      expect(matches[0].breadcrumb[2].id).toBe('cat-6');
    });
    ...
    it('should find multiple categories matching query', () => {
      ...
      const matches = filterCategoriesBySearch(index, 'ight');
    ...
    it('should include matched query in result', () => {
      ...
      expect(matches).toHaveLength(1);
      expect(matches[0].matchedQuery).toBe('split');
    });
  });
});
